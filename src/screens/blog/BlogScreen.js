    ...
    return <div className='container'>
      ...
      <div className='blog_content'>
        <div className='blog_item row'>
          <div className='rectangle'><p className='blog_date'>date of post</p>
          <div className='blog_card'>
            <img className='blog_image' src='../../assets/vectors/blogimage.svg' />
            <div className='blog_card_catergory'><p>Catergory</p>
            <p className='post_title'>Post title</p>
            <p classNam='content'>Here is the content of the blog</p>
        ...
        <div className='blog_right_row'>
          <div className='blog_catergory'>
            <div className='catergory_title'><p>Catergory</p>
            <div className='catergory_group1'>
              <div className='catergory_types'><p className="cat_name">Catergory type </p>
              </div>
            </div>
            </div>
          </div>
          ...
          <div className='resent_post'>
            ...
            <div className='resent_post_title'><p className='post_title'>Post title</p>
